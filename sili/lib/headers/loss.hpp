...
VALUE_TYPE mse_loss(const VALUE_TYPE* output, const VALUE_TYPE* desired, const size_t n) {
...
template <typename VALUE_TYPE>
void mse_grad(const VALUE_TYPE* output, const VALUE_TYPE* desired, VALUE_TYPE* grad_out,
              const size_t n) {
...
template <typename VALUE_TYPE>
VALUE_TYPE mse_loss_parallel(const VALUE_TYPE* output, const VALUE_TYPE* desired, const size_t n,
                             const int num_cpus) {
    VALUE_TYPE acc = VALUE_TYPE(0);
...
template <typename VALUE_TYPE>
void mse_grad_parallel(const VALUE_TYPE* output, const VALUE_TYPE* desired, VALUE_TYPE* grad_out,
                       const size_t n, const int num_cpus) {
    const VALUE_TYPE scale = VALUE_TYPE(-2) / VALUE_TYPE(n);

...
int main() {
    ...
    run_arm<PlainRMSpropSynapsePolicy>("plain", 0.0f, 1e30f, plain_checkpoints,
                                       plain_max_after_200);
    run_arm<BoundedRMSpropSynapsePolicy>("bounded", 0.9995f, 1.0f, bounded_checkpoints,

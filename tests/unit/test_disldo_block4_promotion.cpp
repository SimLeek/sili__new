...
int main() {
    ...
    bool ok2 = delta_csr_synap_row_step<SIZE_TYPE, FP4BiPacked, COL_TYPE>(weights, current_row,
                                                                          -1e9f, SIZE_TYPE(10));
    ...
    bool ok3 = delta_csr_synap_row_step<SIZE_TYPE, FP4BiPacked, COL_TYPE>(weights, current_row,
                                                                          -1e9f, SIZE_TYPE(10));

...
from sili.sparse_rnn import FoldedLayer, fit_rank1_scale_envelope
...
class TestFromDescriptorValueScaleMode:
    def test_invalid_mode_raises(self):
        ...
        with pytest.raises(ValueError, match="value_scale_mode"):
            FoldedLayer.from_descriptor(desc, learning_rate=0.01, num_cpus=1,
                                        value_scale_mode="bogus")
    ...
    def test_per_row_mode_is_still_the_default_and_unchanged(self):
        ...
        layer_explicit = FoldedLayer.from_descriptor(
            desc, learning_rate=0.01, num_cpus=1, value_scale_mode="per_row")
    ...
    def test_rank1_mode_sets_a_nontrivial_output_scale(self):
        ...
        layer = FoldedLayer.from_descriptor(
            desc, learning_rate=0.01, num_cpus=1, value_scale_mode="rank1")
    ...
    def test_rank1_mode_recovers_lower_quantization_error_than_per_row(self):
        ...
        layer_per_row = FoldedLayer.from_descriptor(
            desc, learning_rate=0.01, num_cpus=1, value_scale_mode="per_row")
        layer_rank1 = FoldedLayer.from_descriptor(
            desc, learning_rate=0.01, num_cpus=1, value_scale_mode="rank1")
